...
## RCON
A simple CLI app to directly interact with the database. Useful for minimal setups that might not need the [Server](#server) component.
...
- [`discord_ext`](extensions/discord_ext.py): Used by the [Discord bot](#discord-bot) to link leagues, tournaments and users to discord
